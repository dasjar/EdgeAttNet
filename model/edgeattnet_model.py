...
from edgeattnet_model import UNetEdgeTransformer  # Import your custom model
from dataset import CustomDataset  # Import your custom dataset class
from evaluation import evaluate_model, visualize_prediction_by_filename, generate_all_boxplots_in_row  # Import evaluation functions
...
def main():
    ...
    model = UNetEdgeTransformer()  # Use your custom UNetEdgeTransformer model
    model.to(device)
    ...
    test_dataset = CustomDataset(root=test_data_path, mode="test")  # Load your dataset
